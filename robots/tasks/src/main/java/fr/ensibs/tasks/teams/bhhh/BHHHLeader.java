...
public class BHHHLeader implements RobotTask<TeamLeader>
{
    public static final String TEAM_NAME = "BHHH";
    public static final java.awt.Color TEAM_COLOR = new java.awt.Color(0, 255, 0);
    ...
    public void run()
    {
        if (leader.getEnergy() <= 0) return;
        
        try {
            leader.turnRadar(10.0 * radarDirection);
            moveCounter++;
            if (moveCounter % 36 == 0) radarDirection *= -1;
